...
export default function DoctorOnboard() {
    return (
      <>
                  ...
                  <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <label htmlFor="education" className="block text-sm font-medium text-gray-700">
                        ...
                        <input
                          ...
                          name="education"
                          id="education"
                          placeholder="Enter your education comma-seperated"
                          autoComplete="given-name"
                          className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2 shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                    <label htmlFor="experience" className="block text-sm font-medium text-gray-700">
                        ...
                        <input
                          ...
                          name="experience"
                          id="experience"
                          placeholder="Enter your experience NUMERIC VALUE (in years)"
                          autoComplete="given-name"
                          className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2 shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                    </div>
        ...
        <div className="mt-10 sm:mt-0 mx-12">
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="col-span-6">
                        ...
                        <input
                          ...
                          className="mt-1 focus:ring-indigo-500 p-2 focus:border-indigo-500 p-2 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                      </div>
                      ...
                      <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                        ...
                        <input
                          ...
                          className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block p-2 w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                      </div>
                        ...
                        <div className="flex items-start">
                          <div className="flex items-center h-5">
                            <input
                              ...
                              name="comments"
                              type="checkbox"
                              className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded p-2"
                            />
                          </div>
